function [t,x,desVel,desAcc,sentCommand] = inputCTDynamics_DI(position,velocity,attitude,thrust,input,velPrev,accPrev,conTime,ku,kv,kw,Tsbar)

global thrustDesired thetaDesired phiDesired psiDesired u1 u2 u3
...
[t,x] = ode45(@systemCTModel_DI,conTime,xo);
